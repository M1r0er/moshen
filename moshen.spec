...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'knowledge.relation_graph_render',
        # analysis (星图)
        'analysis',
        'analysis.base',
        'analysis.chapter_split',
        'analysis.progress',
        'analysis.portrait',
        'analysis.relation_graph_analyzer',
        'analysis.foreshadowing_analyzer',
        # routes
        'routes',
        'routes.chat',
        'routes.project',
        ...
        'routes.workspace',
        'routes.knowledge',
        'routes.settings_writer',
        'routes.conversation',
        'routes.outline',
        'routes.writing',
        'routes.foreshadowing',
        'routes.relations',
        # main
        'main',
    ],
